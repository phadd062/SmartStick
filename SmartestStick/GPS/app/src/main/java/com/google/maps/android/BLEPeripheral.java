...
import com.google.maps.android.ConnectActivity;
...
public class BLEPeripheral {
    ...
    public BLEPeripheral(ConnectActivity connector, String deviceId) {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        StringBuilder buffer;
                ...
                public void onCharacteristicRead(BluetoothGatt param1BluetoothGatt, BluetoothGattCharacteristic param1BluetoothGattCharacteristic, int param1Int) {
                    if (param1Int == 0) {
                        BLEPeripheral.this.mConnector.log(String.format("onCharacteristicRead received: [%s] value: [%s]", new Object[] { param1BluetoothGattCharacteristic.getUuid().toString(), new String(param1BluetoothGattCharacteristic.getValue()) }));
                        if ((new String(param1BluetoothGattCharacteristic.getValue())).contains("close")) {
                            mConnector.getSound(1).start();

                        }
                        if ((new String(param1BluetoothGattCharacteristic.getValue())).contains("far")) {
                            mConnector.getSound(2).start();

                        }
                        return;
                    }
                    BLEPeripheral.this.mConnector.log(String.format("onCharacteristicRead fail received: [%s]", new Object[] { Integer.valueOf(param1Int) }));
                }
